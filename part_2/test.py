...
#         # Recreates an np.array since we want to convert the value type to no.float32
...
#             candidate_info_tup.isNodulebool
#         ],
#         dtype = torch.long)
